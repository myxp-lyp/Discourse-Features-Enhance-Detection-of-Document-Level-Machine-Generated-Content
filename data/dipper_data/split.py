...
# Example usage:
input_file = '/data/yl7622/MRes/DIPPER_data/my_data/lfqa.MGC'
train_data, valid_data, test_data = split_data(input_file)

# Write the split data to separate files
with open('/data/yl7622/MRes/DIPPER_data/my_data/train.MGC', 'w', encoding='utf-8') as file:
    file.writelines(train_data)

with open('/data/yl7622/MRes/DIPPER_data/my_data/valid.MGC', 'w', encoding='utf-8') as file:
    file.writelines(valid_data)

with open('/data/yl7622/MRes/DIPPER_data/my_data/test.MGC', 'w', encoding='utf-8') as file:
